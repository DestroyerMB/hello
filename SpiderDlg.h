...
public:
	...
	CEdit m_EmailStart;
	CEdit m_EmailStop;
	CEdit m_AddressStart;
	CEdit m_OkresStart;
	CEdit m_KrajStart;
	CEdit m_BusinessStart;
	CEdit m_BusinessStart;
	CEdit m_AddressStop;
	CEdit m_OkresStop;
	CEdit m_KrajStop;
	CEdit m_BusinessStop;
	CEdit m_WebStop;
	...
	CEdit m_AddressStartShift;
	CEdit m_OkresStartShift;
	CEdit m_KrajStartShift;
	CEdit m_BusinessStartShift;
	CEdit m_WebStartShift;
